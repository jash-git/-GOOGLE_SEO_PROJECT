...
$sql_1="SELECT * FROM `all` WHERE 1=1 LIMIT $v1,1";
$sql_2="SELECT * FROM `all` WHERE 1=1 LIMIT $v2,1";
$sql_3="SELECT * FROM `all` WHERE 1=1 LIMIT $v3,1";
$sql_4="SELECT * FROM `all` WHERE 1=1 LIMIT $v4,1";
